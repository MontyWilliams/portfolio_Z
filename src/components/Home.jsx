...
const Home = () => {
  return (
    <div name="home" className="w-full min-h-0 bg-gradient-to-b from-black ">
        <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full p-4 md:flex-row text-white">
            <div className="flex flex-col justify-center h-full">
                <h2  className="text-4xl sm:text-7xl font-bold hover:z-[-1000]">I'm a full Stack Developer</h2>
